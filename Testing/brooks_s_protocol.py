...
class Brooks(object):
    ...
    *SLA document* will be referenced to this document.
    ...
    Args:
        ...
        port: comport
    """
    def __init__(self, tag, port='COM7'):
...
if __name__ == "__main__":
    ...
    BROOKS = Brooks(tag,'COM7') #CRHEA=COM5, HOME=COM8
    
    # command 11:
    response=BROOKS.comm('8280000000000b06'+BROOKS.pack(tag))
    print(response) # Print the Brooks response when command 11 is executed
    
    # long address:
    print(BROOKS.long_address) # Read Hex long address 
    ...
    try:
        while True:
            # Your code here
                ...
                print(BROOKS.read_flow()) # Read flow rate 
                print(BROOKS.read_setpoint()) # Read current set point value and unit
                print(BROOKS.read_flow_range()) # Read current flow rate value and unit
